...
import com.example.sharingapp.ItemController;
...
public class AddItemActivity extends AppCompatActivity {
   ...
   private EditText title;
    ...
    private boolean validateInput() {
        String[] fields = {title_str, maker_str, description_str, length_str, width_str, height_str};
        EditText[] editTexts = {title, maker, description, length, width, height};

        for (int i = 0; i < fields.length; i++) {
            if (fields[i].equals("")) {
                editTexts[i].setError("Empty field!");
                return false;
            }
        }
